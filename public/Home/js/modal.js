...
that.$element.addClass('in').prop('aria-hidden',false);
that.enforceFocus();
...
this.$element.removeClass('in').prop('aria-hidden',true).off('click.dismiss.bs.modal');
...
$target.modal(option,this).one('hide',function(){$this.is(':visible')&&$this.trigger('focus')})})}(jQuery);